defmodule Manager.Management do
  @moduledoc """
  ...
  """
  def get_area!(id), do: Repo.get!(Area, id) |> Repo.preload(:devs) |> Repo.preload(:tasks)
  ...
  def list_statuses do
    Repo.all(Status)|> Repo.preload(:assignments)
  end
  ...
  """
  def get_status!(id), do: Repo.get!(Status, id) |> Repo.preload(:assignments)
